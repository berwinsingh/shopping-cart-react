...
const GameCard = (props) => {
  return (
    <>
      <div onClick={props.viewItemHandler} className="mt-2 bg-white flex flex-col drop-shadow-md rounded-xl h-84 w-84 cursor-pointer" key={props.id}>
        <div
        ...
        <div className="game-content flex flex-col items-center gap-1">
          ...
          <h3 className="text-md">{props.releaseDate}</h3>
        </div>

        <div className="bottom-content flex justify-between">
            <div className="add-to-cart-shortcut absolute">
            <button
                type="button"
